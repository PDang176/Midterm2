...
typedef enum detect_eq_states { DEQInit, DEQClear, DEQOccur } detect_eq_states;
typedef enum detect_max_amp_states { DMAInit, DMAMax_Amp } detect_max_amp_states;
typedef enum detect_zc_states { DZCInit, DZCClear, DZCOccur } detect_zc_states;
